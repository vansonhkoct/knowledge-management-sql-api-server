...
# 定义模型路径
mode_name_or_path = 'THUDM/glm-4-9b-chat'
...
def get_model():
    ...
    model = AutoModelForCausalLM.from_pretrained(mode_name_or_path, torch_dtype=torch.bfloat16,  trust_remote_code=True).to('cuda')
